...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  #**** Test for making sure the new sponsor post is added to the DB ****
  describe "POST create" do
    it "increases the number of Sponsor Post by 1" do
    ...
    it "assigns the new sponsor_post to @sponsor_post" do
    ...
    it "redirects to the new sponsor_post" do
      post :create, topic_id: my_topic.id, sponsored_post: {title: RandomData.random_sentence, body: RandomData.random_paragraph, price: rand(1000)}
  ...
  describe "PUT update" do
    it "updates sponsored post with expected attributes" do
      ...
      expect(updated_spost.id).to eq my_sponsored_post.id
